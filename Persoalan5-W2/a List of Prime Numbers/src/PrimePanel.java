...
public class PrimePanel extends JPanel
{
    ...
    private JScrollPane scrollablePrimeList;
    // ----------------------------------------------------------
    ...
    public PrimePanel ()
    {
        ...
        scrollablePrimeList = new JScrollPane(primeList);
        //scroll.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        scrollablePrimeList.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
    ...
    public class ButtonListener implements ActionListener
    {
        ...
        public void actionPerformed (ActionEvent event)
        {
            ...
            if (num < 2)
                ...
                JFrame f;
                f = new JFrame();
                JOptionPane.showMessageDialog(f,"Please write a value before"
                        + "\ngenerating." + "\nNumber Only!");                
            }
    }
}
