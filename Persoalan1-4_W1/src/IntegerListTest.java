    ...
    public static void dispatch(int choice)
    {
        ...
        switch(choice)
        {
            ...
            case 5:
                ...
                val = scan.nextInt();
                System.out.println("Runtime Before Searching: "+System.currentTimeMillis());
                loc = list.linearSearch(val);
                if (loc != -1)
                    System.out.println("Found at location " + loc +
                            "Runtime After Searching: "+ System.currentTimeMillis());
                else
                    System.out.println("Not in list");
                    System.out.println("Runtime After Searching: "+System.currentTimeMillis());
                break;
            case 6:
                System.out.print("Enter the value to look for: ");
                val = scan.nextInt();
                ...
                break;
            case 7:
                System.out.println("Runtime Before Sorting: "+System.currentTimeMillis());
                list.sortDecreasing();
                System.out.println("List has been sorted.");
                System.out.println("Runtime After Sorting: "+System.currentTimeMillis());
                break;
            case 8:
                System.out.println("Runtime Before Sorting: "+System.currentTimeMillis());
                list.sortIncreasing();
